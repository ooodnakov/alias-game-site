  ...
  return (
    <div className="space-y-24 pb-24">
        ...
        <div className="mt-10 grid gap-8 md:grid-cols-3">
          <figure className="flex flex-col gap-4">
            ...
            <figcaption className="text-sm text-foreground/70">
              {t("screenshots.captions.game")}
            </figcaption>
          </figure>
          <figure className="flex flex-col gap-4">
            <ScreenMockup variant="filters" />
            <figcaption className="text-sm text-foreground/70">
              {t("screenshots.captions.filters")}
            </figcaption>
          </figure>
          <figure className="flex flex-col gap-4">
            <ScreenMockup variant="history" />
            <figcaption className="text-sm text-foreground/70">
              {t("screenshots.captions.history")}
            </figcaption>
          </figure>
        </div>
      </section>
      ...
      <section className="bg-primary text-primary-foreground">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 px-6 py-16 text-center md:flex-row md:justify-between md:text-left">
          <div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 md:justify-end">
            ...
            <Button asChild size="lg" variant="ghost">
              <Link href="/decks" className="text-primary-foreground">
                {t("cta.browse")}
              </Link>
            </Button>
            <Button asChild size="lg" variant="ghost">
